...
int main() {
    // Cria uma lista duplamente encadeada com capacidade máxima de 10
    IntDoubleLinkedList list(10);
    ...
    int value;
    if (list.get(1, value)) {
        cout << "Valor no índice 1 é: " << value << endl; // Esperado: 1
    } else {
        cerr << "ERRO04: Não foi possível obter o valor no índice 1." << endl;
    }

    list.set(1, 20);
    cout << "Lista após definir o valor no índice 1 para 20: " << list.str() << endl; // Esperado: |10|20|4|
